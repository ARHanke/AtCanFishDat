---
title: "Create a Summary of the contents of each Observer table"
author: "Alex Hanke"
date: "March 30, 2016"
...
```{r cars}
TableName = subset(sqlTables(channel,schema="OBSERVER"),select=c(TABLE_SCHEM,TABLE_NAME))
...
# Create a list of OBSERVER tables where eac table has 4 rows  
for(i in TableName){
...
for(i in (1:length(Table_desc))[valid] ){
  ...
  nodata <- as.data.frame(setNames(replicate(5,numeric(0), simplify = F), letters[1:5]))
   names(nodata) = c(names(temp)[1],1:4)
...
write.csv(Table_desc2, file="OBSERVER_tables_summary.csv")
```
